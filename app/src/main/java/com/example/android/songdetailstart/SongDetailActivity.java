...
public class SongDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int position = getIntent().getIntExtra(SongUtils.SONG_ID_KEY, 0);

        SongDetailFragment songDetailFragment = SongDetailFragment.newInstance(position);
        getSupportFragmentManager().beginTransaction()
                .add(R.id.song_detail_container, songDetailFragment)
                .commit();
    }
